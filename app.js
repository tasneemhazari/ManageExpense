...
var UIController= (function(){
    ...
    return{
        ...
        addListItem: function(obj,type) {
            //Create HTML stringd with the placeholder text
...
var controller=(function(budgetCtrl,UICtrl){
    ...
    var updatePercentages= function(){
        ...
        //2. Read and return the percentages.
        var percentages= budgetCtrl.getPercentages();

        //3. Show and update the percentage.
...
var controller= (function(budgetCtrl, UIctrl){
    ...
    return{
        init: function(){
            console.log('Application has startted');
            UIctrl.displayMonth();
            UIctrl.displayBudget({
                budget:0,
                totalInc:0,
